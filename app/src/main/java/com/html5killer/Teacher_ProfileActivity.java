...
public class Teacher_ProfileActivity extends AppCompatActivity implements ChangePasswordDialog.Listener
        ,NavigationView.OnNavigationItemSelectedListener {

    public static final String TAG = Teacher_ProfileActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_activity_profile);
